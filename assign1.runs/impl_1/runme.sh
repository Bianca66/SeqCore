...
HD_PWD='C:/Users/bianca.palade/Desktop/assignment1/assign1.2 - Copy/assign1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seq_core.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seq_core.tcl -notrace
